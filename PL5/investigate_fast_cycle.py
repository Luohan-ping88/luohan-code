...
try:
    with open(os.path.join(PROJECT_ROOT, "src", "app", "auto_scheduler_v8.py"), "r", encoding="utf-8") as f:
        content = f.read()
...
cfg_path = os.path.join(PROJECT_ROOT, "config", "scheduler_config.json")
...
# 4. 检查系统昨日是否有训练
print("\n[4] 训练活动检查:")
model_path = os.path.join(PROJECT_ROOT, "models", "enhanded_predictor_v10.pkl")
...
print("\n[5] 数据版本检查:")
dv_path = os.path.join(PROJECT_ROOT, "models", "data_version.json")
