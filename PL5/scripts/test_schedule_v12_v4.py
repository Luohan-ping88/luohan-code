...
def main():
    print('='*100)
    print('PL5 V12 - 多智能体时间协调系统 V4.0')
    print('='*100)
    print('⚠️  核心任务预算：800分钟以上（约13.3小时）')
    print('='*100)
    ...
    coord.register_task("模型评估", estimated_duration_minutes=10, priority=4,
                        dependencies=["数据采集"], is_core_task=True, estimated_actual_minutes=20)
