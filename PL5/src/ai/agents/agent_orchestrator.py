...
class AgentOrchestrator:
    ...
    def run_task(self, task: str, context: Optional[Dict[str, Any]] = None, agent_name: Optional[str] = None) -> ToolResult:
        """执行任务
    ...
    def run_chat(self, messages: List[ConversationMessage], context: Optional[Dict[str, Any]] = None, agent_name: Optional[str] = None) -> ToolResult:
        """执行对话
        ...
        # 选择对话Agent
        if agent_name is None:
            agent_name = "conversation_agent" if "conversation_agent" in self._agents else self.select_agent("chat", context)
