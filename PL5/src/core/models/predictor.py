...
MODEL_PARAMS = {
    "stacking": {
        "rf": {"n_estimators": [50, 100], "max_depth": [6, 8, 10]},
        "gbm": {"n_estimators": [50, 100], "max_depth": [3, 4, 5]},
        "et": {"n_estimators": [50, 100], "max_depth": [6, 8, 10]},
    },
    "hmm": {"n_states": [3, 4, 5]},
    "bsts": {"alpha": [0.03, 0.05, 0.07]},
    "evm": {"threshold": [8.0, 9.0, 10.0]},
}
