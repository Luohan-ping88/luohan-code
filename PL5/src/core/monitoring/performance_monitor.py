...
class PerformanceMonitor:
            ...
            try:
                ...
                if system == 'Windows':
                    ...
                    try:
                        ...
                        metrics['system']['memory_used_mb'] = (memory_status.ullTotalPhys - memory_status.ullAvailPhys) / 1024 / 1024
                        ...
                        if result.returncode == 0:
                            ...
                            for line in lines:
                                if '总字节数' in line:
                                    ...
                                    if total_bytes > 0:
                                        metrics['system']['disk_used_gb'] = (total_bytes - free_bytes) / 1024 / 1024 / 1024
    ...
    def establish_baseline(self):
        ...
        cpu_values = [m['system']['cpu_percent'] for m in recent_metrics if 'system' in m and 'cpu_percent' in m['system']]
        memory_values = [m['system']['memory_percent'] for m in recent_metrics if 'system' in m and 'memory_percent' in m['system']]
        disk_values = [m['system']['disk_percent'] for m in recent_metrics if 'system' in m and 'disk_percent' in m['system']]
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        # 计算统计信息
        cpu_values = [m['system']['cpu_percent'] for m in self.performance_history if 'system' in m and 'cpu_percent' in m['system']]
        memory_values = [m['system']['memory_percent'] for m in self.performance_history if 'system' in m and 'memory_percent' in m['system']]
        disk_values = [m['system']['disk_percent'] for m in self.performance_history if 'system' in m and 'disk_percent' in m['system']]
