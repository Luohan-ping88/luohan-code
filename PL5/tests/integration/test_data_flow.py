...
class TestDataFlowIntegration:
    ...
    def test_collector_to_features_flow(self, temp_dir, sample_raw_data, monkeypatch):
        ...
        # 2. 特征工程
        engineer = FeatureEngineerV9(use_config=False, enable_parallel=False, cache_max_size=5)

        features_df = engineer.extract_all_features(raw_df, select_top=None, enable_scaler=False)
    ...
    def test_features_to_prediction_flow(self, temp_dir, monkeypatch):
        ...
        features_df = engineer.extract_all_features(raw_df, select_top=50, enable_scaler=True)  # 选择Top 50特征
