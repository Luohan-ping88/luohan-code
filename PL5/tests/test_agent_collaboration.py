...
async def test_collaborative_decision():
    ...
    try:
        ...
        # 测试模型选择决策
        logger.info("\n2. 测试模型选择协同决策")
        model_context = {"features": "sample_features", "target": "wan"}
        ...
        # 测试系统优化任务
        logger.info("\n4. 测试系统优化任务")
        optimization_params = {"features": "sample_features", "feature_cols": ["feature1", "feature2", "feature3"]}
        ...
        # 测试预测改进任务
        logger.info("\n5. 测试预测改进任务")
        prediction_params = {"data": "sample_data", "feature_cols": ["feature1", "feature2", "feature3"]}
