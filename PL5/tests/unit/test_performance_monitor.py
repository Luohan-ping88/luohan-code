...
class TestPerformanceMonitor:
    ...
    def test_set_thresholds(self):
        """测试设置性能告警阈值"""
        monitor = PerformanceMonitor()
        new_thresholds = {"cpu_percent": 70, "memory_percent": 80, "disk_percent": 85}
    ...
    def test_alert_callback(self):
        ...
        # 触发一个告警
        test_alert = {"type": "test_alert", "timestamp": time.time()}
    ...
    def test_get_alert_history(self):
        ...
        # 添加一些告警
        for i in range(5):
            alert = {"type": f"test_alert_{i}", "timestamp": time.time() + i}
