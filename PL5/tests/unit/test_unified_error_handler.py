...
class TestPL5Error:
    ...
    def test_pl5_error_to_dict(self):
        """测试PL5Error转换为字典"""
        error = PL5Error(
            message="Test error", error_type=ErrorType.UNKNOWN_ERROR, severity=ErrorSeverity.ERROR_SEVERITY_MEDIUM
        )
...
class TestDataErrors:
    ...
    def test_data_error(self):
        """测试DataError"""
        error = DataError(message="Data error", data_source="test_source", record_count=100)
...
class TestModelErrors:
    ...
    def test_model_error(self):
        """测试ModelError"""
        error = ModelError(message="Model error", model_name="test_model", operation="predict")
...
class TestOtherErrors:
    ...
    def test_config_error(self):
        """测试ConfigError"""
        error = ConfigError(message="Config error", config_key="test_key")
